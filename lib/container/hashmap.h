...
{ \
	alloc_var_flush ( (_self)->hash_prev ); \
	alloc_var_flush ( (_self)->next ); \
	alloc_var_flush ( (_self)->content ); \
\
...
{ \
        ...
        if ( _new_cnt > 2*(_self)->n_elm ) { \
                ...
                (_self)->hash_prev      = alloc_var_expand2((_self)->hash_prev, _len); \
                (_self)->next           = alloc_var_expand2((_self)->next, _len); \
                (_self)->content        = alloc_var_expand2((_self)->content, _new_cnt); \
\
