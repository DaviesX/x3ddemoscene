...
${OBJECTDIR}/_ext/1548469272/editrenderframe.o: ../../usr/editor/editrenderframe.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1548469272
	${RM} "$@.d"
	$(COMPILE.cc) -g -DX3D_COMPILER_GCC -DX3D_PLATFORM_POSIX -I../../lib -I../../include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1548469272/editrenderframe.o ../../usr/editor/editrenderframe.cpp
