...
void __private  call_log_normal(const char *functionName, const char *message, ...);
void __private  call_log_mild_err(const char *functionName, const char *errorMessage, ...);
void __private  call_log_severe_err(const char *functionName, const char *errorMessage, ...);
void __private  call_log_critical_err(const char *functionName, const char *errorMessage, ...);
