...
${OBJECTDIR}/_ext/501084237/ptshader.o: ../../drivers/renderer/shader/ptshader.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/501084237
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DX3D_COMPILER_GCC -DX3D_PLATFORM_POSIX -I../../include -I../../lib -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/501084237/ptshader.o ../../drivers/renderer/shader/ptshader.c
...
${OBJECTDIR}/_ext/1109276195/panic.o: ../../kernel/panic.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1109276195
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DX3D_COMPILER_GCC -DX3D_PLATFORM_POSIX -I../../include -I../../lib -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1109276195/panic.o ../../kernel/panic.c
