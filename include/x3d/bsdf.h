...
typedef void (*f_BSDF_Sample) (struct bsdf_model* self, struct ray3d* reflected);
typedef void (*f_BSDF_Li) (struct bsdf_model* self, struct ray3d* reflected,
